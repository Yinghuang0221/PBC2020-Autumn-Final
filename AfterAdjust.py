...
class PageOne(tk.Frame):
    ...
    def createWidgets(self):      
        ...
        self.rdiq44 = tk.Radiobutton(self, text='同意',variable=valueq4,value=4)
        self.rdiq45 = tk.Radiobutton(self, text='非常同意',variable=valueq4,value=5)
        ...
        self.rdiq54 = tk.Radiobutton(self, text='高風險接受者',variable=valueq5,value=4)
        self.rdiq55 = tk.Radiobutton(self, text='極高風險接受者',variable=valueq5,value=5)
        ...
        self.rdiq64 = tk.Radiobutton(self, text='清楚(我知道不同市場，不同標的有不同報酬與風險)',variable=valueq6,value=4)
        self.rdiq65 = tk.Radiobutton(self, text='很清楚(我知道所有的金融市場，也熟悉影響投資報酬與風險之因素)',variable=valueq6,value=5)
        ...
        self.rdiq74 = tk.Radiobutton(self, text='不同意',variable=valueq7,value=4)
        self.rdiq75 = tk.Radiobutton(self, text='非常不同意',variable=valueq7,value=5)
        ...
        self.rdiq84 = tk.Radiobutton(self, text='樂觀',variable=valueq8,value=4)
        self.rdiq85 = tk.Radiobutton(self, text='非常樂觀',variable=valueq8,value=5)
